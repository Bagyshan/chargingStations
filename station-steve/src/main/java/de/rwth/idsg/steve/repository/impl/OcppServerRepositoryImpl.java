...
public class OcppServerRepositoryImpl implements OcppServerRepository {
    ...
    public boolean hasConnector(int connectorId, String chargeBoxId) {
        return (Integer) this.ctx
                .selectCount()
                .from(Connector.CONNECTOR)
                .where(Connector.CONNECTOR.CONNECTOR_ID.equal(connectorId))
                .and(Connector.CONNECTOR.CHARGE_BOX_ID.equal(chargeBoxId))
