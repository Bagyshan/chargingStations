...
public class KafkaConfig {
    ...
    // ── Отдельные фабрика/шаблон для аудита: value = JSON-объект (без type-заголовков),
    //    чтобы audit-log-service читал его как Map. Строковый kafkaTemplate для этого не годится
    //    (он бы дважды закодировал JSON). ──
    @Bean
